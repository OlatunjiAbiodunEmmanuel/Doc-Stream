...
const shaerDocumentHandler = async ()=>{
  setLoading(true)
...
<Button className='gradient-blue flex h-9 gap-1 px-4' disabled={currentUserType !=="editor"}>
  ...
  <p className='mr-1 hidden sm:block'>Share</p>
    ...
    <DialogContent className='shad-dialog'>
      ...
      <div className='flex flex-1 rounded-md gap-3'>
...
<Button type='submit' onClick={shaerDocumentHandler} className='gradient-blue flex h-full gap-1 px-5' disabled={loading}>
